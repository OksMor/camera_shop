...
function CatalogAddItemModal (props : CatalogAddItemModalProps) : JSX.Element {
  const { isCatalogAddItemModalOpen, setCatalogAddItemModalOpen, camera } = props;
          ...
          <div className="modal__content">
            ...
            <div className="basket-item basket-item--short">
              <div className="basket-item__img">
                <picture>
                  <source type="image/webp" srcSet={`${process.env.PUBLIC_URL}/${camera.previewImgWebp}, ${process.env.PUBLIC_URL}/${camera.previewImgWebp2x}`} />
                  <img src={`${process.env.PUBLIC_URL}/${camera.previewImg}`} srcSet={`${process.env.PUBLIC_URL}/${camera.previewImg2x}`} width="140" height="120" alt={camera.name} />
                </picture>
              </div>
            ...
            <div className="modal__buttons">
              {!inBasket ?
                ...
                </button> : <button className="btn btn--purple product-card__btn" type="button" onClick={handleButtonClick}>Добавить в корзину</button>}
