...
function ProductReviewSuccessModal(props: ProductReviewSuccessModalProps): JSX.Element {
  const { isReviewSuccessModalOpen, setReviewSuccessModalOpen } = props;
        ...
        <div className="modal__wrapper">
          ...
          <div className="modal__content">
            ...
            <div className="modal__buttons">
              <button className="btn btn--purple modal__btn modal__btn--fit-width" type="button" onClick={closeModal}>
